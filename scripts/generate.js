 ...
 * @prop {Record<'base'|'ansi'|'brightOther'|'other', string[]>} pablo - Life of Pablo color variables.
...
const transformSoft = theme => {
    ...
    const brightColors = [...soft.pablo.ansi, ...soft.pablo.brightOther];
